...
<%--                         <address>${sessionScope['user'].email}</address>--%>
                     <h2 class="text-sky-600">Welcome to Kalpix LTD</h2>
                     <p class="text-sky-600">you can now start downloading applications</p>
                         <div>
                             <a class="font-semibold text-blue-400 underline mr-3" href="/student">View Student</a>
                             <a class="font-semibold text-blue-400 underline mr-3" href="/student">Download</a>
